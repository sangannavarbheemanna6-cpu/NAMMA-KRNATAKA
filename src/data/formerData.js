...
<section className="space-y-4">
  ...
  <div className="grid gap-3">
    ...
    {WEATHER_LOCATIONS.map((location) => {
      ...
      const alert = WEATHER_ALERTS.find(
        ...
        >
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <div>
              ...
              <p className="font-semibold">
                {RR(location.district, lang)}
              </p>

              <p className="text-sm text-muted-foreground">
                📍 {RR(location.city, lang)}
              </p>
          ...
          {alert ? (
            ...
            <div className="mt-3">
              ...
              <p className="text-sm text-muted-foreground">
                {lang === "kn"
                  ? "ಈ ಸ್ಥಳಕ್ಕೆ ಪ್ರಸ್ತುತ live alert ಲಭ್ಯವಿಲ್ಲ."
                  : "No live alert is currently available for this location."}
              </p>

              <a
                href={WEATHER_SOURCES.districtWarnings}
                target="_blank"
                rel="noopener noreferrer"
                className="mt-2 inline-block text-sm font-medium underline"
              >
                {lang === "kn"
                  ? "ಅಧಿಕೃತ IMD ಎಚ್ಚರಿಕೆ ನೋಡಿ"
                  : "View Official IMD Warning"}
              </a>
