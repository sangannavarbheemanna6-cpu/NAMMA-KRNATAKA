...
/* =========================================================
   WEATHER ALERTS & OFFICIAL WEATHER SOURCES
========================================================= */
...
/*
 * IMPORTANT:
 * Keep this empty until live IMD/backend data is connected.
 * Do NOT put current weather alerts manually here.
 */
...
export const WEATHER_LOCATIONS = DISTRICTS.map(district => ({
  id: district.id,
  name: district.name,
...
export const WEATHER_SOURCES = {
  ...
  districtWarnings:
    "https://mausam.imd.gov.in/imd_latest/contents/districtwise-warning_mc.php?id=13",
  ...
  districtForecast:
    "https://mausam.imd.gov.in/imd_latest/contents/agromet/advisory/indiadistrictforecast.php"
};
